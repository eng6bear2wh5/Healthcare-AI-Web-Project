// src/components/DiseaseDetectButton.jsx
...
function DiseaseDetectButton() {
    ...
    const handleAnalyze = () => {
        ...
        setTimeout(() => {
            setResult({
                name: "Bệnh ABC",
                description: "Đây là mô tả ngắn về bệnh ABC.",
            });
        }, 1000);
    };
    ...
    const handleSend = () => {
        if (input.trim() !== "") {
            ...
            setTimeout(() => {
                const aiMessage = { text: `Bạn vừa nói: "${userMessage.text}"`, sender: "bot" };
            ...
            <AnimatePresence>
                {showMenu && (
                    <motion.div
                        ...
                        className="fixed bottom-5 right-5 left-5 bg-white border shadow-2xl rounded-2xl w-[90%] h-[80%] z-50 flex flex-col p-6 space-y-4 overflow-auto"
                    >
                        {!selectedOption && (
                            ...
                            <div className="flex flex-col gap-4 w-full items-center">
                                ...
                                <label className="flex flex-col items-center justify-center w-64 h-40 border-2 border-dashed border-gray-400 rounded-lg cursor-pointer hover:border-blue-500">
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        >
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16V4m0 0L3 8m4-4l4 4M21 12v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-8m16 0l-4-4m4 4l-4 4" />
                                        </svg>
                                ...
                                {result && (
                                    <div className="mt-4 text-center">
                                        <h3 className="text-lg font-semibold text-green-600">{result.name}</h3>
