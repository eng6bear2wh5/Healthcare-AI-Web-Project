// pages/PharmaInformation/MedicineDetail.jsx
import { useParams } from "react-router-dom";
import { useEffect, useState } from "react";
import { getDrugById } from "../../api/drugApi";

function MedicineDetail() {
  useEffect(() => {
      document.title = "Thông tin thuốc | HealthTrust";
    }, []);
  ...
  if (!medicine)
    return <div className="text-red-600">Không tìm thấy thông tin thuốc.</div>;
