import { Routes, Route, Navigate } from "react-router-dom"; // Không import BrowserRouter hay Router ở đây!
      ...
      <main className="flex-grow min-h-screen">
        <CategoryProvider>
          ...
          <Routes>
            ...
            <Route
              path="/personal-tracker/health-log"
              element={<WeeklyHealthInput />}
            />
            <Route
              path="/personal-tracker/dashboard"
              element={
            ...
            />
            <Route
              path="/personal-tracker/edit-profile"
              element={
                <Suspense fallback={<div>Đang tải...</div>}>
                  <EditProfile />
                </Suspense>
            ...
            <Route
              ...
              element={<Navigate to="/personal-tracker/dashboard" replace />}
            />
            <Route path="/AboutHealthTrust/Mission" element={<Mission />} />
            <Route
              path="/PharmaInformation/MedicineList"
            ...
            <Route
              path="/PharmaInformation/MedicineDetail/:id"
              element={<MedicineDetail />}
            />
            <Route
              path="/Community/ScheduleBlood"
              element={<ScheduleBlood />}
            />
            ...
            />
            <Route
              path="/HealthCheck/BodyFatCalculator"
            ...
            <Route
              path="/Category/DiseaseList/:categoryId"
              element={<DiseaseList />}
            />
            <Route
              path="/Category/DiseaseDetail/:diseaseId"
