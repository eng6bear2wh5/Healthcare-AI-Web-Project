...
export default function Toast({ message, onClose, type = "info", duration = 6000 }) {
  ...
  return (
    <div className={`fixed top-35 right-6 z-50 shadow-lg rounded px-4 py-3 text-white flex items-start gap-3 min-w-56 max-w-xs animate-slide-in ${bg}`} role="alert">
